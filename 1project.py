...
icon='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIJEFhUSXemOE3elUwQaHxfn0vyc1Rxumqjg&s'
st.set_page_config(page_title='Youtube Data Harvesting and Warehousing using SQL & Streamlit',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by N.P.Nivesh'})

st.title("🗃️:rainbow[Youtube Data Harvesting and Warehousing using SQL & Streamlit]📡")
